...
```
***
Two first heatmap shows only songs of Spinvis. The second heatmap shows songs of overlapping genres. Overall there are not many big differences between the two heatmaps and the features presented. However the songs of spinvis are generally more higher oriented on each feature rather than low, compared to the overlapping genre songs. Which seems to be slightly more low oriented. 
In the Spinvis songs there is the song 'Onder Woorden' which spotify gave a very low value of dancebility. In addition, the song 'Aap' assigned spotify as very speechiness.   
Interesting to see in the heatmap of overlapping genres, is that most songs are valued around +/- 0 for speechiness. However the song 'Hell N Black' was valued really high for speechiness by spotify. 
