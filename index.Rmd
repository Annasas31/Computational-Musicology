...
<iframe src="https://open.spotify.com/embed/track/53BEvoEYpcQ7418Ed4VMtg?utm_source=generator" width="100%" height="352" frameborder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
***
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/1005SKXxknjHvBI2qBoYRP?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe> 

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/6STbsnrajWWZnnnWxqoFFv?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
spinvisplot_bar <- ggplot(spinvis_project1, aes(x = Feature, y = Value, fill = Category)) +
  geom_bar(stat = "identity", position = "dodge") +  # Use stat = "identity" to use the 'y' values directly
  labs(fill = "Category") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  scale_fill_manual(values = c("darkorange", "darkred"))  

plot(spinvisplot_bar)
...
spinvisGenre <-
  get_playlist_audio_features(
    "",
    "6STbsnrajWWZnnnWxqoFFv"
  ) |>
  slice(1:45) |>
  add_audio_analysis()
comparison <-
  spinvis |>
  mutate(genre = "spinvis") |>
  bind_rows(spinvisGenre |> mutate(genre = "spinvisgenre"))

```

```{r echo=FALSE}
comparison %>%
  ggplot(aes(x = tempo, fill = genre)) +
  ...
  labs(
    ...
    y = "Frequency",
    fill = "Genre",
    title = "Histogram of Mean Tempo by Genre"
  )
